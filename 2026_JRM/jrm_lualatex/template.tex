...
%If you use Supporting Online Materials for refering websites, please use the following format.
\vspace{5pt}
\noindent
\begin{onlinematerials}{99}
	\bibitem[a]{web}%
	``JRM Website.''
...
%Supporting Online Materials にBibTeXを利用する場合
%\bibliographystyleOnline{fujipressbib}
%\bibliographyOnline{refdata}%.bib filename
